...
public class BarcodeCode93Extended {
    static final String DEFAULT_DATA = "Code93 ext: abcXYZ!?";
    static final String OUTPUT_FILE_NAME = "code93-extended.png";
    ...
    public static void main(String[] args) {
        try {
            Code93ExtendedOptions options = new Code93ExtendedOptions();
