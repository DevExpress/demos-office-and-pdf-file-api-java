...
public class BarcodeDeutschePostIdentcode {
    static final String DEFAULT_DATA = "12345678901";
    static final String OUTPUT_FILE_NAME = "deutsche-post-identcode.png";
    ...
    public static void main(String[] args) {
        try {
            DeutschePostIdentcodeOptions options = new DeutschePostIdentcodeOptions();
