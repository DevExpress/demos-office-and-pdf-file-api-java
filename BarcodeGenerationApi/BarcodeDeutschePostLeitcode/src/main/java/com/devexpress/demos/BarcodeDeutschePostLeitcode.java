...
public class BarcodeDeutschePostLeitcode {
    static final String DEFAULT_DATA = "12345678901234";
    static final String OUTPUT_FILE_NAME = "deutsche-post-leitcode.png";
