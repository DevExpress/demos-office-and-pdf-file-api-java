...
public class BarcodeGs1DataBar {
    static final String DEFAULT_DATA = "(01)09521234543213";
    static final String OUTPUT_FILE_NAME = "gs1-databar.png";
    ...
    public static void main(String[] args) {
        try {
            DataBarOptions options = new DataBarOptions();
