...
public class BarcodeIntelligentMail {
    static final String DEFAULT_DATA = "92123912345678123456";
    static final String OUTPUT_FILE_NAME = "intelligent-mail.png";
    ...
    public static void main(String[] args) {
        try {
            IntelligentMailOptions options = new IntelligentMailOptions();
