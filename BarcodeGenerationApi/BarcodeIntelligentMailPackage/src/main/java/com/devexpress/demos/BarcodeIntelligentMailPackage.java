...
public class BarcodeIntelligentMailPackage {
    static final String DEFAULT_DATA = "9212391234567812345671";
    static final String OUTPUT_FILE_NAME = "intelligent-mail-package.png";
