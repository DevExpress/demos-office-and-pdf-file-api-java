...
public class BarcodeMicroQrCode {
    static final String DEFAULT_DATA = "HELLO123";
    static final String OUTPUT_FILE_NAME = "micro-qr.png";
    ...
    public static void main(String[] args) {
        try {
            MicroQRCodeOptions options = new MicroQRCodeOptions();
