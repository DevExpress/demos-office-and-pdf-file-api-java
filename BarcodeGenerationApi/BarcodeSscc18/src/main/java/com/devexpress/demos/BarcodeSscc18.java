...
public class BarcodeSscc18 {
    static final String DEFAULT_DATA = "12345678901234567";
    static final String OUTPUT_FILE_NAME = "sscc18.png";
    ...
    public static void main(String[] args) {
        try {
            SSCCOptions options = new SSCCOptions();
